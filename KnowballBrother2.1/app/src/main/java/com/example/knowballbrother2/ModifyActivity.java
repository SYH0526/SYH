...
public class ModifyActivity extends AppCompatActivity {
    ...
    private void initModify(){
        Modify m1 =new Modify(R.drawable.football_1,"热血驰骋球场，浙商大足球少年用热爱书写青春");
        modifyList.add(m1);
        Modify m2 =new Modify(R.drawable.football_1,"热血驰骋球场，浙商大足球少年用热爱书写青春");
        modifyList.add(m2);
        Modify m3 =new Modify(R.drawable.football_1,"热血驰骋球场，浙商大足球少年用热爱书写青春");
        modifyList.add(m3);
    }
}
